...
internal static class Strings
{
    ...
    public static string OpenUrl_AutoGeneratedSubtitleFormat => Get("OpenUrl_AutoGeneratedSubtitleFormat");

    public static string OpenUrl_AutoGeneratedTranslatedSubtitleFormat => Get("OpenUrl_AutoGeneratedTranslatedSubtitleFormat");
